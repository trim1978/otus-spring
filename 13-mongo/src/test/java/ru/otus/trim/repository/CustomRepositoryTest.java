...
public class CustomRepositoryTest {
    ...
    public static void initDB(@Autowired MongoTemplate template) {
        Author author1 = template.insert(new Author("author1"));
        Author author2 = template.insert(new Author("author2"));
        template.insert(new Book("book1", author1, List.of("genre")));
        template.insert(new Book("book2", author2, List.of("genre")));
    }
...
//        List<Book> actual = bookRepository.findByAuthor(new Author("author1"));
//        assertThat(actual).isNotNull();
